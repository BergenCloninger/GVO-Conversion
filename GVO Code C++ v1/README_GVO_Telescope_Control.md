...
This project is under active development. The current C++ version supports:
...
Some behavior, especially controller origin, park alignment, TPoint/TheSky offset behavior, and physical axis direction, should still be verified carefully on hardware.
