...
// Slew based on target and current quadrant
	If ((TargetQuadrant = 1) And (Quadrant = 1)) Then
		GoQuad1to1(Xcount, Ycount)
	else If ((TargetQuadrant = 3) And (Quadrant = 1)) Then
		GoQuad1to3(Xcount, Ycount)
	else If ((TargetQuadrant = 3) And (Quadrant = 3)) Then
		GoQuad1to3(Xcount, Ycount)
	else If ((TargetQuadrant = 1) And (Quadrant = 3)) Then
